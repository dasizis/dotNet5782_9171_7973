...
namespace PL.ViewModels
{
    class StationDetailsViewModel 
    {
        ...
        public StationDetailsViewModel(int id)
        {
            ...
            OpenDronesListCommand = new(() => Workspace.AddPanelCommand.Execute(Workspace.DronesListPanel(d => Station.DronesInCharge.Exists(drone => drone.Id == d.Id), Workspace.StationChrgedDronesName(Station.Id))),
